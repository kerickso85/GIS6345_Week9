...
def L8_TCT(inputL8Directory, full = False):
    ...
    start = folderName.index('LC08') #my image ID's began with LC08, not the default LC8 in the source
    l8Code = folderName[start:start+36] #Realizing I had a different image ID length...
    #...it was necessary to bump the +21 up to +36
...
print('Tasseled-cap transformation rasters have been saved to the active directory.') #to let me know when it's done :)

Greenness = rasterio.open('c:/imagery folder/LC08_L1TP_149021_20200809_20200809_01_RT/LC08_L1TP_149021_20200809_20200809_0_Greenness.tif') #access the directory containing the Band2 raster pertaining to greenness

rasterio.plot.show(Greenness) #display the greenness raster
         
L8_TCT(r"c:/imagery folder/LC08_L1TP_149021_20200809_20200809_01_RT")
